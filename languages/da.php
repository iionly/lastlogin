...
return array(
	...
	'lastlogin:settings:registered_time' => 'Vis oprettet dato? ',
	'lastlogin:settings:guid' => 'Vis medlemmets GUID og sti til data bibliotek (Kun synlig for admins)? ',
	'lastlogin:settings:no' => 'Nej',
	'lastlogin:settings:yes' => 'Ja',
	'lastlogin:settings:admin' => 'For admins only',
	'lastlogin:settings:all' => 'For alle'
);