...
return [
	...
	'lastlogin:settings:guid' => 'Afficher le GUID des membres et le chemin vers le répertoire de données (visible uniquement par les admins)? ',
